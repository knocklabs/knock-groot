...
running command...
$ groot (--version)
knock-groot/0.0.25 darwin-arm64 node-v16.14.0
$ groot --help [COMMAND]
USAGE
  $ groot COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/knocklabs/knock-groot/blob/v0.0.25/dist/commands/hello/index.ts)_
